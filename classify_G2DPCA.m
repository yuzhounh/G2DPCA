function classify_G2DPCA(database,iS,iP)
...
fprintf('classify_G2DPCA_par(%s,%d,%d)\n\n',database,iS,iP);
...
time=toc/60;
save(sprintf('result/classify_G2DPCA_%s_iS%d_iP%d.mat',database,iS,iP),'accuracy','time');